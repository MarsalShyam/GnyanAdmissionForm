document.getElementById('studentForm').addEventListener('submit', function (e) {
    ...
    const formData = {
      ...
      diplomaSubject: document.getElementById('diplomaSubject').value,
      diplomaTotalMarks: document.getElementById('diplomaTotalMarks').value,
      diplomaPercentage: document.getElementById('diplomaPercentage').value,
      degreeSubject: document.getElementById('degreeSubject').value,
      degreeTotalMarks: document.getElementById('degreeTotalMarks').value,
